"""
Dealer 4 Spider - Placeholder
Template for adding fourth dealer
"""
import time
import logging
...
class Dealer4Spider(BaseSpider):
    """
    Placeholder spider for fourth dealer
    """
    ...
    def run(self, product_urls=None):
        ...
        try:
            logger.info(f"Starting Dealer4 scraper for {self.dealer.name}")
            self.init_browser()
